...
function isAllGood(typeOfForm) {
    if (typeOfForm === 'register') {
        eventoBtn(isInRegister ? isOkPasswordRegister && isOkNameRegister && isOkEmailRegister : isOkPasswordRegister && isOkEmailRegister, typeOfForm);
...
function isPasswordEqual() {
    if (isInRegister) {
        const passwordConfirm = document.querySelector('#register__password-confirm').value;
...
function passwordConfirmFunction() {
    if (isInRegister) {
        const passwordConfirm = document.querySelector('#register__password-confirm').value;
        const password = document.querySelector('#register__password').value;
        const spanPasswordConfirm = document.querySelector('#register__span-password-confirm');
...
function iconActiveFunction(typeOfPassword) {
    ...
    if (typeOfPassword == 'passwordConfirmRegister') {
        isIconPasswordConfirmReActive = isIconPasswordConfirmReActive ? false : true;
...
document.querySelector('#register__name').addEventListener('input', nameFunction);
document.querySelector('#register__password-confirm').addEventListener('input', passwordConfirmFunction);
...
document.addEventListener('DOMContentLoaded', () => {
    async function handleRegister(e) {
        ...
        const username = document.querySelector('#register__name').value;
        const email = document.querySelector('#register__email').value;
        const password = document.querySelector('#register__password').value;
        ...
        try {
            ...
            console.error(error)
            alert('Error de registro de usuario:' + error.message)
        }
    }
    ...
    document.querySelector('#form__register').addEventListener('submit', handleRegister)
    document.querySelector('#form__login').addEventListener('submit', handleLoguin)
})
